...
<head>
    ...
    <title>About Us | KRMUCANTEEN</title>
</head>
...
<body class="d-flex flex-column h-100">
    ...
    <div class="container form-signin text-center restricted mt-auto">
            ...
            <h4 class="mt-2 mb-3 fw-normal ">KR Mangalam University</h4>
            <p class="mt-2 mb-3 fw-normal h6 ">Department Of School of Engineering & Technology</p>
            <p class="mb-3 fw-bold text-bold text-wrap">KRMUCANTEEN</p>
            <h4 class="mt-2 mb-3 fw-normal ">Mentor Name</h4><p class="mt-2 mb-3 fw-normal h6 ">Ms. kriti Sharma</p>
